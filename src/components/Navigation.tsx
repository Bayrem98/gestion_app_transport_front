      ...
      <nav className="navigation">
        ...
        <ul className="nav-links">
          ...
          {(userRole === "Utilisateur" ||
            ...
            userRole === "Comptabilité") && (
            <li>
              <Link
                to="/import-agents"
                className={
                  location.pathname === "/import-agents" ? "active" : ""
                }
              >
                📊 Dashboard
              </Link>
          ...
          {/* Lien Societes - pour Utilisateur et Administrateur */}
          {(userRole === "Utilisateur" || userRole === "Administrateur") && (
            <li>
              <Link
                to="/societes"
                className={location.pathname === "/societes" ? "active" : ""}
              >
                🏢 Sociétés
              </Link>
            </li>
          ...
          {(userRole === "Utilisateur" || userRole === "Administrateur") && (
            <li>
              <Link
                to="/chauffeurspage"
                className={
                  location.pathname === "/chauffeurspage" ? "active" : ""
                }
              >
                🚐 Chauffeurs
              </Link>
          ...
          {(userRole === "Utilisateur" || userRole === "Administrateur") && (
            <li>
              <Link
                to="/affectations"
                className={
                  location.pathname === "/affectations" ? "active" : ""
                }
              >
                🎯 Affectation
              </Link>
